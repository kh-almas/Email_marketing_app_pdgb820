...
class SingleSend
{
    ...
    //"{"results":[{"id":2344442,"nickname":"almas38","from_email":"check.almas@daytodays.com","from_name":"almas","reply_to":"check.almas@daytodays.com","reply_to_name":"","address":"65/8-billbobari,gonpara","address2":"","state":"","city":"barishal","country":"BGD","zip":"8205","verified":true,"locked":false}]}
    ...
    public function addSingleSend()
    {
        ...
        $response = Http::withHeaders([
            ...
            'name' => 'checkSenderName',
            'send_to' => [
                'list_ids' => [
                    'b98f50e0-4238-4de2-9de3-eba85db0da7b',
                ],
            ],
            'email_config' => [
                'subject' => 'This is subject',
                'generate_plain_content' => true,
                'suppression_group_id' => 16539,
                'sender_id' => 2344442,
