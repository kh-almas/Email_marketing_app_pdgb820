                    ...
                    <div class="flex flex-col">
                        <div class="overflow-x-auto overflow-y-hidden sm:-mx-6 lg:-mx-8">
                            <div class="overflow-y-auto inline-block py-2 min-w-full sm:px-6 lg:px-8">
                                ...
                                <a href="{{ route('dashboard.sms.send.failed.retry') }}" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Retry</a>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        @forelse($all_data as $info)
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    <p>{{ $info->error_code_description }}</p>
                                                </td>
                                                <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
